...
import { scaleIn, staggerContainer, slideInLeft } from "@/lib/animations";
...
export function FeaturesSection() {
  ...
  const stats = [
    { icon: Users, value: "80+", label: "Happy Clients", iconClass: "text-violet-600 bg-violet-100" },
            ...
            {stats.map((stat, index) => {
              ...
              return (
                <motion.div
                  key={index}
                  variants={scaleIn}
                  className="flex flex-col items-center text-center p-6 bg-white rounded-2xl shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
                >
